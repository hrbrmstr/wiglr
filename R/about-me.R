#' Get WiGLE user object for the current logged-in user
#'
#' @param api_key WiGLE API Key. See [wigle_api_key()]
#' @return `list` or invisible JSON API response if unsuccessful and a 2xx.
#' @export
wigle_about_me <- function(api_key=wigle_api_key()) {
  httr::GET(
